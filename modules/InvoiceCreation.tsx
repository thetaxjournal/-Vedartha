...
const InvoiceCreation: React.FC<InvoiceCreationProps> = ({ branches, activeBranchId, clients, initialInvoice, onPost, onCancel }) => {
  ...
  const InvoiceDocument = () => (
    <div className="flex flex-col text-[#000000]">
      ...
      <div id="invoice-render-p1" className="bg-white w-[210mm] min-h-[297mm] p-[15mm] relative text-[#000000] font-sans overflow-hidden flex flex-col page-break-after-always">
        {/* Header Section */}
        ...
        <div className="mt-auto flex flex-col pt-8">
          <div className="flex justify-between items-end mb-6">
            <div className="shrink-0">
              <QRCode value={`V-ERP-3.7|${invoiceNumber}|₹${grandTotal.toFixed(2)}`} size={100} level="M" fgColor="#000000" />
            </div>
      ...
      {/* PAGE 2 */}
      <div id="invoice-render-p2" className="bg-white w-[210mm] min-h-[297mm] p-[15mm] relative text-[#000000] font-sans overflow-hidden flex flex-col mt-[5mm] page-break-after-always">
